...
namespace Pulumi.Wpinstance
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Wpinstance.version.txt");
    ...
    internal sealed class WpinstanceResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public WpinstanceResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
